...
`/ba-frame` renders the source inventory, the profile picker and the scope-frame
block together, as one stop, and takes all three answers in one reply
(the inventory · P-O0 · P-O0b). The mechanical run
