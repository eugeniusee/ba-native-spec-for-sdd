...
python3 - "$RULES_DOC" <<'PYX' && ok "the D-O block runs 1…102 with no gap and no skipped number" \
...
sys.exit(0 if seen == set(range(1, 103)) else 1)
PYX
