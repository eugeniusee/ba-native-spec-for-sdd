...
Phase 2 build, session **S1 of S9** complete (foundation). See
...
| S2 | 10 checker scripts · toy-world fixtures | pending |
...
```sh
tests/check-layout.sh --target /path/to/project --session S1   # this session's bar
