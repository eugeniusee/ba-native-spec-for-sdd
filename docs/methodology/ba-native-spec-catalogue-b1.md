...
### BA-Native Spec · Wave 2 · Frame & foundation · v0.5 — captured sources join T-01's inputs (13 August 2026; B3 mirrors 30 July 2026; review incorporated 25 July 2026)
...
| 13 | Context/Constraints | one-liners per class (technical · business · regulatory); detail owned by `constraints.md` (#5) from the Context aspect on; scope-frame lines land here where a frame stands — budget envelope · delivery boundary · client label, each cited (D-B1-5) |
```
