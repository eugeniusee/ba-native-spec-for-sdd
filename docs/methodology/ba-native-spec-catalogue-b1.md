...
### BA-Native Spec · Wave 2 · Frame & foundation · v0.6 — the canvas mirror carries scope decisions (18 August 2026; B3 mirrors 30 July 2026; review incorporated 25 July 2026)
...
| 13 | Context/Constraints | one-liners per class (technical · business · regulatory); detail owned by `constraints.md` (#5) from the Context aspect on; scope-frame lines land here where a frame stands — budget envelope · delivery boundary · client label · scope decisions (`SD-<n>`), each cited (D-B1-5 · D-B1-7) |
```
...
*v0.6 · the canvas mirror carries scope decisions, applied 18 August 2026 (D-B1-7 — T-01 §4 step 2, the §5 §13 template row, the §8 build hook; D-B1-6's fence untouched; review record above) · v0.5 · captured sources join T-01's inputs, applied 13 August 2026 (D-B1-6 — T-01 §4 step 1, the §8 build hook; the question-free boundary stated once; review record above) · v0.4 · the scope-frame mirror applied 13 August 2026 (D-B1-5 — T-01 §4 step 2, the §5 §13 template row, the §8 build hook; review record above) · v0.3 · B3 mirrors applied 30 July 2026 (D-B3-1 · D-B3-3) · review incorporated 25 July 2026 · sheets T-01–T-03 of 18 · authored to sequencing-plan §2 template (D-W9 order: contract before procedure) · ★ mining pattern established at T-01 · D-W8 executed — T-02 to the no-reference pattern; plan erratum ready to apply · decisions D-B1-1…D-B1-6 locked (review records above) · consumed by: batches B2–B6 (cite, never restate) · next: B2 — Stakeholders & Context breadth (T-04…T-07), standing batch prompt §4*
