...
### BA-Native Spec · contract runtime · v0.14 — boundary coverage runs: CC-H-08's classing, counting and run points — the epic the element, named and counted, never a block (§10.1 · §10.2 · §10.4, 31 Aug 2026)
