...
### BA-Native Spec · contract runtime · v0.13 — the handoff that runs itself: the adapter's three acts at implementation take-up, automatic and silent while clean, one plain-language refusal on divergence · the floor three acts · the boundary lifts by the PASS alone (§7.1 · §11.2 · §11.3 · §13, 28 Aug 2026)
...
| roadmap | CC-H-02 · CC-H-03 · CC-H-07 (the roadmap half — rows outside the head's `Boundary:` set against standing `AS-<n>` entries) | — |
