...
### BA-Native Spec · aspect & band machinery · v0.9 — §10.5 the WBS export (10 Aug 2026)
...
| **Role** | The story's actor, verbatim from `roles-permissions.md`, first · any role named in the story's linked FRs, its flows (spec §4), or a Business Rule folded into that row's acceptance (D-O24) | Comma-separated |
